...
from schemas.static_pipeline_schemas import PredicateSetDescriptor
...
CapabilitySubject = Literal["root", "bound"]
...
class PredicateEvaluatorSetAdapter(Protocol):
    def enumerate(self, descriptor: PredicateSetDescriptor, contract_address: str | None) -> CapabilityExpr: ...
