...
ALLOW_LIST: dict[str, dict[int, str]] = {
    "workers/policy_worker.py": {
        ...
        1068: "Notifier side-effect; reanalysis already completed before this fired.",
    },
    "workers/effects_worker.py": {
        ...
        573: "Fork-close cleanup side-effect; does not degrade the stage's verdict output.",
    },
}
