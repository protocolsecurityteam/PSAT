...
class ControlGraphNode(Base):
    ...
    # | NULL (not determined). Rows written before the Wave-4 rename carry
    # 'not_a_contract' for 'not_analyzable' (same meaning; see the schema).
    # ``beyond_depth_horizon`` is a fact about OUR
