...
class EffectInfo(FunctionSurface):
...
class StaticAnalysisPayload(TypedDict):
    ...
    effects: EffectsArtifact | None


StaticAnalysisStageRequest = ContractStageRequest[StaticAnalysisRequest]
StaticAnalysisArtifact = StageArtifact[StaticAnalysisPayload]
