...
sides:
  ...
  * **the tokens** — every reason a tracking plan could not be read. Produced by
    ``services.monitoring.enrollment._load_observation_plan_artifacts`` (five), by
...
===========================  ==============================  ================
``tracked_topics``           ``observation_plan_not_determined`` state
===========================  ==============================  ================
...
NOT_DETERMINED_KEY = "observation_plan_not_determined"
