...
def resolve_contract_capabilities(
    ...
    *,
    ...
    artifact = get_assessment_section(session, analysis_job.id, "predicate_trees", reader=get_artifact)
...
def _analysis_lookup_for_runtime_job(
    ...
    *,
    ...
    runtime_artifact = get_assessment_section(session, runtime_job.id, required_artifact, reader=get_artifact)
    ...
    impl_artifact = (
        get_assessment_section(session, impl_job.id, required_artifact, reader=get_artifact)
        if impl_job is not None
        else None
    )
