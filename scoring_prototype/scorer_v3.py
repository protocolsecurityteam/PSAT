        ...
        for claim in claims:
            ...
            if cid == "flow.out":
                ...
                if rd and rv is not None:
                    ...
                    fl_gated = str(obs.get("reach_indeterminate")).lower() == "true"
                    if fl_gated and fl_usd is not None and fl_usd > 0.0:
                        inst_val = fl_usd
                        val_basis = "observed_reach_floor_usd(>= floor, reach_indeterminate)"
                        citations.append(
                            {
